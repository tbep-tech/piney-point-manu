...
spelling::spell_check_files(here::here('revision/review_response.Rmd'))
```
...
All page and line numbers in the reviewer comments refer to the original submission.  Page and line numbers noted in our response refer to the revised submission. 
...
* __Response__: This line was changed to "An initial phytoplankton bloom (non-harmful diatoms) was first observed...".  This was based on chlorophyll measurements in the vicinity of Port Manataee and cell concentrations enumerated to taxa from laboratory analysis.  The word limit for the abstract prevents these details, but they are presented in text (i.e., line xxx and xxx).
