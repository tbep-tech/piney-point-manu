...
fomoarea3 <- fomo %>% 
  filter(area == 'Area 3')
fomoarea1sg <- fomoarea1 %>% 
  group_by(taxa) %>% 
  summarise(foest = mean(foest)) %>% 
  deframe
